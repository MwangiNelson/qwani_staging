import {
  ...
  HowItStartedGallery,
  HowItStartedBody,
} from "@/components/website/pageUIs/how_it_started/HowItStartedSections";
...
const HowItStarted = async (props: Props) => {
  ...
  return (
    <div className="pb-20">
      <HowItStartedHero content={page} />
      <HowItStartedGallery content={page} />
      <HowItStartedBody content={page} />
      <MinimalFooter />
    </div>
  );
};
